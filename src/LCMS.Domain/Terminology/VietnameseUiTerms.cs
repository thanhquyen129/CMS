...
public static class VietnameseUiTerms
{
    ...
    public static IReadOnlyDictionary<string, string> All { get; } = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["EXCEPTION_ESCALATED"] = "Ngoại lệ đã leo thang",
        ["EXCEPTION_SLA_DUE"] = "Hạn xử lý ngoại lệ (SLA)",
        ["EXCEPTION_OVERDUE"] = "Ngoại lệ quá hạn",
        ["VARIANCE_SEVERITY"] = "Mức độ chênh lệch",
        ["APPROVAL_LEVEL"] = "Cấp phê duyệt",
        ["APPROVAL_MULTI_STEP"] = "Phê duyệt nhiều bước",
        ["BLOCK_CONFIRM_CRITICAL_EXCEPTION"] = "Chặn xác nhận khi còn ngoại lệ critical",
        ["RECONCILIATION_BATCH"] = "Đối soát theo lô",
        ...
        ["AUDIT_BEFORE"] = "Trước thay đổi",
        ["AUDIT_AFTER"] = "Sau thay đổi",
        ["AUDIT_DATE_FROM"] = "Từ ngày",
        ["AUDIT_DATE_TO"] = "Đến ngày",
        ["INTEGRATION_RECORD"] = "Bản ghi tích hợp",
        ["INTEGRATION_ERROR"] = "Lỗi tích hợp",
        ["INTEGRATION_RETRY"] = "Thử lại tích hợp",
        ["INTEGRATION_DEAD_LETTER"] = "Dead-letter tích hợp",
        ["OUTBOX_MESSAGE"] = "Thông điệp outbox",
        ["OUTBOX_ENQUEUE"] = "Đưa vào outbox",
        ["OUTBOX_PROCESS_ONCE"] = "Xử lý outbox một lần",
        ["IDEMPOTENCY"] = "Tính bất biến khi gửi lại",
        ["CORRELATION_ID"] = "Mã tương quan",
        ["RATE_LIMIT"] = "Giới hạn tốc độ",
        ["RATE_LIMIT_MONEY_PATH"] = "Giới hạn tốc độ đường tiền",
        ["SECURITY_HEADER"] = "Tiêu đề bảo mật",
        ["UAT_CHECKLIST"] = "Danh mục UAT",
        ["PASS2_COMPLETE"] = "Pass 2 hoàn tất",
