...
|--------|--------|
| 0–5 FULL | Done |
| 6 Financial Documents FULL | Done (see `SPRINT-6-FULL-DOD.md`) |
| 7 Exposure + AP/AR FULL | Done (see `SPRINT-7-FULL-DOD.md`) |
| 8 Settlement FULL | In PR (`PROMPT-SPRINT-8-FULL.md` / `SPRINT-8-FULL-DOD.md`) |
| 9–12 FULL | Queued |
