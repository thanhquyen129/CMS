...
public static class VietnameseUiTerms
{
    ...
    public static IReadOnlyDictionary<string, string> All { get; } = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["PARTY_TAX_ID"] = "Mã số thuế",
        ["PARTY_LEGAL_NAME"] = "Tên pháp lý",
        ["PARTY_BANK_ACCOUNT"] = "Tài khoản ngân hàng đối tác",
        ["PARTY_CONTACT"] = "Người liên hệ",
        ...
        ["MATCH_DETAIL_REVERSED"] = "Chi tiết khớp đã hủy",
        ["REVERSE_MATCH"] = "Hủy khớp",
        ["REVERSE_RECOGNIZE"] = "Hủy ghi nhận",
        ...
        ["SETTLEMENT_REVERSAL"] = "Hoàn tác tất toán",
        ["ALLOCATION_DRAFT"] = "Nháp phân bổ",
        ["ALLOCATION_FINALIZED"] = "Đã chốt phân bổ",
        ["ALLOCATION_REVERSED"] = "Đã hủy phân bổ",
        ["REVERSE_ALLOCATION"] = "Hủy phân bổ",
