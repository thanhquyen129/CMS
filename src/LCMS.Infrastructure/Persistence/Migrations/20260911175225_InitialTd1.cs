...
{
    /// <inheritdoc />
    public partial class InitialTd1 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_business_parties", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    bill_type = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "ix_bills_tenant_id_bill_no",
                table: "bills",
                columns: new[] { "tenant_id", "bill_no" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "ix_bills_tenant_id_source_system_external_id",
                table: "bills",
                columns: new[] { "tenant_id", "source_system", "external_id" });

            migrationBuilder.CreateIndex(
                name: "ix_business_parties_tenant_id_code",
