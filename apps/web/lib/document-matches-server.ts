...
import type { DocumentMatch } from "./document-matches";
...
export function getDocumentMatch(
  id: string
): Promise<ApiResult<DocumentMatch>> {
  return apiGet<DocumentMatch>(`/api/document-matches/${id}`);
}
