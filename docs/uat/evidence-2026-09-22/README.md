...
- EN footer “Best Available” on some KPI cards (UX-02 polish).
- `/operations/legs/new` help text still says unlink unavailable (stale; unlink lives on Bill drawer).
- UX-04 / UX-06 / UX-07 / UX-10 / UX-12 / UX-13 not exercised in this run.
