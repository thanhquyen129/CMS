...
| UX-10 | Keyboard + label | Tab qua form tạo Bill/cost; đọc status | Focus visible; label/accessible name; status không chỉ màu | **Not run** | Vòng focus CSS: `docs/uat/ux-10-keyboard.md`. Chưa Tab trên host từ Đăng nhập → Bill → Chi phí → Chốt |
